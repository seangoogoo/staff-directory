 ...
 *
 * This script tests the database configuration with a custom database name:
 * - Custom database name (staff_dir_test)
 * - No table prefix
 * - Create database if it doesn't exist
 */

echo "Testing Custom Database Name\n";
echo "===========================\n\n";
...
$env_content = preg_replace('/DB_NAME=.*/', 'DB_NAME=staff_dir_test', $env_content);
...
$conn->query("DROP DATABASE IF EXISTS staff_dir_test");
